...
/// );
/// ```
final approvalStatusChoicesProvider = FutureProvider<List<ApprovalStatusChoice>>((ref) async {
  ...
  try {
    ...
    for (var json in response) {
      try {
        final choice = ApprovalStatusChoice.fromJson(json as Map<String, dynamic>);
